...
; 
; WRITTEN BY:
; BOOTLOADER AND KERNEL  : HARSH SIKHWAL
; COMMAND LINE INTERFACE : SWARNAVA MUKHERJEE
;
;------------------------------------------------------------------------
...
;----------------------------------------------------------------
	...
	MSG_AUTHOR        DB 13,10,"THE 16-BIT DOS.",13,10,"WRITTEN BY:-",13,10,"BOOTLOADER AND KERNEL : HARSH SIKHWAL",13,10,"COMMAND LINE INTERFACE: SWARNAVA MUKHERJEE",0
